...
fun AppNavRail(
    ...
    NavigationRail(
        ...
        NavigationRailItem(
            ...
            icon = { Icon(Icons.Filled.Home, stringResource(R.string.concert_title)) },
            label = { Text(stringResource(R.string.concert_title)) },
        ...
        NavigationRailItem(
            selected = currentRoute == JetnewsDestinations.SETTINGS_ROUTE,
            onClick = navigateToSettings,
            icon = { Icon(Icons.Filled.Settings, stringResource(R.string.Settings)) },
