...
import com.example.jetnews.ui.settings.SettingsRoute
import com.example.jetnews.ui.settings.SettingsViewModel
...
fun JetnewsNavGraph(
    ...
    NavHost(
        ...
        composable(JetnewsDestinations.SETTINGS_ROUTE) {
            SettingsRoute(navigateToHome = navigateToHome)
        }
    }
}
