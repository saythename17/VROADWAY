 ...
 */
val seventeen = PostAuthor("Seventeen", "https://medium.com/@pmaggi")
...
val jose =
    PostAuthor("Seventeen", "https://medium.com/@JoseAlcerreca")
...
val post1 = Post(
    ...
    metadata = Metadata(
        ...
        date = "August 02",
        readTimeMinutes = 1,
        runningTime = "00:03:01",
        contentSize = "523MB"
    ),
    paragraphs = paragraphsPost1,
    imageId = R.drawable.post_01_thumb,
    imageThumbId = R.drawable.post_01_thumb
)
...
val post2 = Post(
    ...
    imageId = R.drawable.post_02_thumb,
    imageThumbId = R.drawable.post_02_thumb
)
...
val post3 = Post(
    ...
    imageThumbId = R.drawable.post_03_thumb
)

val post4 = Post(
    id = "84eb677660d9",
    title = "손오공",
    subtitle = "Alternative Jersey club 방향성을 담은 곡으로, 드럼 샘플의 반복 등 Jersey Club의 주요 특징들과 Afrobeats가 결합된 사운드가 특징이다.",
...
val post5 = Post(
    ...
    imageThumbId = R.drawable.post_05_thumb
)

val main_post = Post(
    id = "84eb677660d9",
    title = "세븐틴 정규 7집 Face the sun 드디어 정식 출시!",
    subtitle = "세븐틴의 에너지가 다시 폭발하는 시간...회심의 역작! 미니 10집 [FML] 지금 당신이 느끼는 좌절감 OK! 하지만 당신의 삶까지 비관하는 마인드는 NO!",
    url = "https://medium.com/androiddevelopers/locale-changes-and-the-androidviewmodel-antipattern-84eb677660d9",
    publication = publication,
    metadata = Metadata(
        author = seventeen,
...
val posts: PostsFeed =
    PostsFeed(
        highlightedPost = main_post,
        recommendedPosts = listOf(post1, post2, post3, post4, post5),
        popularPosts = listOf(
            post5,
            post1.copy(id = "post6"),
            post2.copy(id = "post7")
